...
bin/lambda : bin/Lexer.o bin/Error.o bin/AST.o bin/Scanner.o bin/Values.o bin/Environment.o bin/Main.o
	$(CXX) $(CXXFLAGS) -o bin/lambda bin/Lexer.o bin/Error.o bin/AST.o bin/Scanner.o bin/Values.o bin/Environment.o bin/Main.o
