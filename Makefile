...
bin/lambda : bin/Lexer.o bin/Error.o bin/Values.o bin/Environment.o bin/Preprocess.o bin/AST.o bin/Scanner.o bin/BuiltIn.o bin/Main.o
	$(CXX) $(CXXFLAGS) -o bin/lambda bin/Lexer.o bin/Error.o bin/Values.o bin/Environment.o bin/Preprocess.o bin/AST.o bin/Scanner.o bin/BuiltIn.o bin/Main.o
...
bin/Preprocess.o : bin inc/PCH.h.gch inc/Preprocess.h src/Preprocess.cpp
	$(CXX) $(CXXFLAGS) -c -o bin/Preprocess.o src/Preprocess.cpp
