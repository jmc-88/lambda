...
bin/lambda : bin/Lexer.o bin/Error.o bin/Values.o bin/Environment.o bin/AST.o bin/Main.o
	$(CXX) $(CXXFLAGS) -o bin/lambda bin/Lexer.o bin/Error.o bin/Values.o bin/Environment.o bin/AST.o bin/Main.o
